            ...
            if parsed_result.tool_to_call == "merge_datasets":
                ...
                if len(dfs) >= 2:
                    try:
                        ...
                        # Fallback to single ID inference if no explicit join_columns were provided or they failed
                        if not valid_merge:
                        ...
                        if valid_merge:
                            ...
                            # Fallback: concatenate horizontally if absolutely no keys matched
