...
export const PROMPTS = {
  ORCHESTRATOR_CLASSIFY: (query: string) => `
    ...
    Classify the User Query into one of seven categories:
    ...
    6. "SEGMENTATION": The user wants to segment, outline, or delineate an organ/tumor in a NIfTI scan file (e.g., "segment the right kidney in /path/scan.nii.gz").
