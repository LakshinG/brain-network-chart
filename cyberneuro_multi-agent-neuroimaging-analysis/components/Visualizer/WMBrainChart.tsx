...
// Derived at call time from the configured backend base (HF Space in prod,
// or a localStorage override for local dev) so /align tracks the MCP backend.
const getAlignUrl = () => `${getBackendBaseUrl()}/align`;
