...
const AGENT_ICON: Record<string, React.ReactNode> = {
  ...
  [AgentType.VISION]: <ImageIcon className="w-3.5 h-3.5" />,
  [AgentType.PROPOSAL_REPORTER]: <FileText className="w-3.5 h-3.5" />,
...
const AGENT_LABEL: Record<string, string> = {
  ...
  [AgentType.PROPOSAL_REPORTER]: 'Proposal Reporter',
...
const NODE_THEME: Record<string, { border: string; header: string; icon: string }> = {
  ...
  [AgentType.VISION]:             { border: 'border-cyan-700/60',     header: 'bg-cyan-900/40',     icon: 'text-cyan-400' },
  [AgentType.PROPOSAL_REPORTER]:  { border: 'border-amber-700/60',    header: 'bg-amber-900/40',    icon: 'text-amber-400' },
