...
OPENAI_API_KEY = "default"  # Ollama doesn't require API key for /v1/chat/completions
a2a_host = 'localhost'
# Set environment variables for OpenAI-compatible Ollama endpoint
...
""")
    ...
    print(f"  OpenAI API Endpoint: {os.getenv('OPENAI_API_BASE')}")
